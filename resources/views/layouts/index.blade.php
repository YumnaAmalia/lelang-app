...
<div class="sidebar">
    ...
    <div class="main">
        <div class="content">
            ...
            <!-- NAVBAR -->
            <div class="navbar">
                <h2>Dashboard Perkara Lelang</h2>
                <p>kelola data perkara lelang dengan mudah dan terstruktur</p>
            </div>

            <!-- TOPBAR -->
            <div class="topbar">
                <input type="text" id="searchInput" class="search" placeholder="Cari nama terpidana...">

                <div>

                    <a href="/cases/create">
                        <button class="btn btn-primary">+ Tambah Kasus</button>
                    </a>
                </div>
            </div>
            ...
            <div class="card">
                <table>
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr data-year="{{ \Carbon\Carbon::parse($case->tanggal_putusan)->format('Y') }}">
                            <td>{{ $case->nama_terpidana }}</td>
                            <td>{{ $case->jenis_perkara }}</td>
                            <td>{{ $case->nomor_putusan }}</td>
                            <td class="action-cell">
                                ...
                                <!-- DELETE -->
                                <form action="/cases/{{ $case->id }}" method="POST" onsubmit="return confirm('Yakin hapus data?')">
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn" style="background:red; color:white;">Hapus</button>
                                </form>
...
function toggleAdmin(){
    let el = document.getElementById('adminMenu');
    el.style.display = el.style.display === 'block' ? 'none' : 'block';
}
...
function sortTable(){
    ...
    rows.sort((a,b)=>{
        ...
        let yearA = parseInt(a.dataset.year);
        let yearB = parseInt(b.dataset.year);
